...
<body data-spy="click" data-target=".navbar-nav">
    ...
    <div class="single-blog-popup-wrapper">
        <div class="close-button">
            <img src="<?php echo esc_url( CSTS_DIR_URI . 'public/images/cancel.png' ); ?>" alt="close">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-12">
        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    ...
                    <?php
                    if ( ! empty( $settings['footer_social_icons'] ) ): ?>
                        <div class="col-md-4 col-lg-4 ms-auto">
                            <ul class="social-profile">
                                <?php
                                foreach ( $settings['footer_social_icons'] as $item ): ?>
                                    <li>
