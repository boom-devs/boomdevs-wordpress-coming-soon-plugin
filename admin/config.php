<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'                    => array(
             ...
             array(
                'id'                => 'cst_font_family',
                'type'              => 'typography',
                'title'             => __( 'Font family', 'cs_taspristudio' ),
                'google'            => true,
            ...
            array(
                'id'                => 'cst_color',
                'type'              => 'palette',
                'title'             => __( 'Color', 'cs_taspristudio' ),
                'desc'              => __( 'Choose your color (font color, background color)', 'cs_taspristudio' ),
                'default'           => 'color_1',
                'palettes'          => array(
                    'color_1'       => array(
                        '#fff',
    ...
    Redux::setSection( $opt_name, array(
        'title'                     => __( 'Mail initialize', 'cs_taspristudio' ),
        'id'                        => 'cst_mail_init',
        'subsection'                => true,
        'customizer_width'          => '450px',
        'fields'                    => array(
            array(
                'id'                => 'cst_maillchamp_status',
                'type'              => 'switch',
                'title'             => __( 'Mailchamp', 'cs_taspristudio'),
                'on'                => __( 'Yes', 'cs_taspristudio' ),
                'off'               => __( 'No', 'cs_taspristudio' ),
                'default'           => true,
            ),
            ...
            array(
                'id'                => 'cst_mailchamp_api',
                'type'              => 'text',
                'title'             => __('Enter mailchamp api key', 'cs_taspristudio'),
                'required'          => array('cst_maillchamp_status', '=', '1'),
            ),

            array(
                'id'                => 'cst_mailchamp_listId',
                'type'              => 'text',
                'title'             => __( 'Enter mailchamp list id', 'cs_taspristudio' ),
                'required'          => array('cst_maillchamp_status', '=', '1'),
            ),
